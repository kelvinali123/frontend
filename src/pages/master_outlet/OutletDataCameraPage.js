...
//Memberikan semua list data pada page tersebut dimana diBack end mempunyai data Current limit maupun Current Page
    getListbyPaging()
    {
        var url = `http://10.0.111.31:8083/TampilDataKameraOutlet/${this.state.searchInputtedName}`
        this.isLoading = true;
        fetch(url)
        .then(response => {
            if (response.ok) {
...
//pada saat melakukan edit yang akan di lempar ke backend adalah first_param = nama yang telah di edit, second_param adalah yang didapatkan 
    setEditEkspedisi =  (
        ...
        var payload = {
            camout_outcode:outcode,
            camout_cameracode:datacameracode,
            camout_cameraqty:datacameraqty,
            camout_userid: "0",
        };
        console.log(payload)
...
searchInputValue = (outcode)  =>{
    ...
    var buttonEditted = document.getElementById("buttonEdit");
    var camout_cameraqty = document.getElementById("camout_cameraqty");
    ...
    if(outcode.length > 0 ){
        var url = `http://10.0.111.143:8083/TampilDataKameraOutlet/${outcode}`
        fetch(url)
    ...
    .then(data =>{ 
        ...
        if(data[0] && data[0].outsttk_outcode === true ){
            ...
            camout_cameraqty.disabled = true;
            nama_kamera.disabled = true;
            // this.setState({
    ...
    if(buttonEditted.clicked === true){
        camout_cameraqty.disabled = false;
        nama_kamera.disabled = false;
    }
...
//render biasa nya di-isi untuk desain HTML
    render() {
        ...
        return (
            ...
            <Page
                title       = "Data Camera"
                breadcrumbs = {[{ name: 'Data Camera', active: true }]}
...
<Col  xs = {8} md = {4} >
 ...
 {/* ================================= stocktake =================================*/}
                                            ...
                                            <Table>
                                                <thead>
                                                    <tr align ="center">
                                                        ...
                                                        <th  class="th-sm" >Jumlah Camera</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align = "center">{kam.camout_cameraqty}</td>
                                                        <td align = "center">
                                                            <div>
                                                                <Button 
                                                                    style={{background: '#0000FF', borderStyle: 'none', 
                                            ...
                                            <Row>    
                                                ...
                                                <Row className = "mt-3">
                                                <Label sm={3} style={{fontWeight:"bold"}}>
                                                    Input Jenis Camera dan Jumlah Camera
                                                </Label>
                                            </Row>
